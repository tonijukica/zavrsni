...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="#"><i class="fa fa-link"></i> <span>Prostorije</span></a></li>
        <li><a href="#"><i class="fa fa-link"></i> <span>Nadzorna kamera</span></a></li>
        <li class="treeview">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Kamera
        <small><button id="addBox" class="btn btn-sm btn-info">+</button></small>
      </h1>
