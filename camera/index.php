...
<html>
   ...
   <body class="layout-top-nav hold-transition skin-blue sidebar-mini" onload="setTimeout('init(<?php echo "$mjpegmode, $video_fps, $divider" ?>);', 100);">
   <header class="main-header">
    <!-- Header Navbar -->
    <nav class="navbar navbar-static-top">
        <div class="container">
          <div class="navbar-header">
            <a href="https://adminlte.io/themes/AdminLTE/index2.html" class="navbar-brand"><b>Admin</b>LTE</a>
          ...
          <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
            <ul class="nav navbar-nav">
              <li class=><a href="https://adminlte.io/themes/AdminLTE/pages/layout/top-nav.html#">Pocetna<span class="sr-only">(current)</span></a></li>
              <li class="active"><a href="../camera/index.php">Kamera</a></li>
              <li class="">
                <a href="../index.html" class="">Prostorije</a>
              </li>
                </ul>
              </li>
            </ul>
